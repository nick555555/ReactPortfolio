...
function Resume() {
    return (
        <div className="container" style={{height:"78vh"}}>
            ...
            <iframe width="100%" height="153%" src="https://docs.google.com/document/d/e/2PACX-1vRKldj6pDtI1KsBoLrz6VvKBrM0-gpLNJLRVlGiLiRAhUffyz808ErDUssnmDcccWeC8eBxJ2RPh7EN/pub?embedded=true"></iframe>
        </div>
    )
}
